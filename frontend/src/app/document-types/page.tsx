                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <button
                          ...
                          className="flex items-center space-x-2 px-3 py-2 bg-red-500/20 text-red-400 rounded-lg hover:bg-red-500/30 transition-colors cursor-pointer"
                        >
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="glass-card p-6 max-w-md w-full space-y-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-white text-lg font-semibold">Document Type Verwijderen</h3>
                <p className="text-white/60 text-sm">Deze actie kan niet ongedaan worden gemaakt</p>
              </div>
            </div>
            
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              <p className="text-white/80 text-sm mb-2">Weet je zeker dat je het volgende document type wilt verwijderen?</p>
              <div className="space-y-1">
                <p className="text-white font-medium">{typeToDelete.name}</p>
                <p className="text-white/50 text-xs font-mono">{typeToDelete.slug}</p>
            ...
            <div className="flex space-x-3 pt-2">
              ...
              <button
                ...
                disabled={deleteMutation.isPending}
                className="flex-1 px-4 py-2.5 bg-white/10 text-white rounded-lg hover:bg-white/20 transition-colors cursor-pointer"
              >
                Annuleren
              </button>
            </div>
